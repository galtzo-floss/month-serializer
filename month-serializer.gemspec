...
gem_version =
  if Gem.ruby_version >= Gem::Version.new("3.1")
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/month/serializer/version.rb", mod) }::Month::Serializer::Version::VERSION
  else
    ...
    Month::Serializer::Version::VERSION
  end
...
Gem::Specification.new do |spec|
  ...
  spec.summary = "🗓️ Serialize Month objects to Integer"
  spec.description = "🗓️ Serialize Month objects to Integer"
  spec.homepage = "https://github.com/galtzo-floss/month-serializer"
  spec.licenses = ["MIT"]
  spec.required_ruby_version = ">= 1.9.3" # rubocop:disable Gemspec/RequiredRubyVersion
  ...
  spec.metadata["homepage_uri"] = "https://month-serializer.galtzo.com/"
  ...
  spec.add_development_dependency("rspec-pending_for", "~> 0.1", ">= 0.1.28") # ruby >= 1.8.7
end
