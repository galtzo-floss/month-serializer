...
gem_version =
  if RUBY_VERSION >= "3.1"
    ...
    Module.new.tap { |mod| Kernel.load("lib/month/serializer/version.rb", mod) }::Month::Serializer::VERSION
  else
    # __dir__ introduced in Ruby 1.9.1
    lib = File.expand_path("lib", __dir__)
    $LOAD_PATH.unshift(lib) unless $LOAD_PATH.include?(lib)
    require "month/serializer/version"
    Month::Serializer::VERSION
  end
...
Gem::Specification.new do |spec|
  ...
  #       This gem, and its runtime dependencies, will install on Ruby down to 1.9.3.
