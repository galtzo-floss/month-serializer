...
# month-serializer Rakefile v7.1.0 - 2026-08-02
...
# rake install                                # Build and install month-serializer-1.0.0.gem in...
# rake install:local                          # Build and install month-serializer-1.0.0.gem in...
# rake kettle:jem:install                     # Internal target used by `kettle-jem install`
# rake kettle:jem:selftest                    # Self-test: template month-serializer against itse...
