# kettle-jem:freeze
# To retain chunks of comments & code during month-serializer templating:
# Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
# month-serializer will then preserve content between those markers across template runs.
# kettle-jem:unfreeze
